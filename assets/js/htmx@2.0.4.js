/*
This file has been modified so that it does not boost image links.

After you have modified this file, do:

pnpm i -g terser || npm i -g terser
terser --compress --mangle --define htmx --output htmx@2.0.4.min.js htmx@2.0.4.js
*/
...
var htmx = (function() {
  ...
  function boostElement(elt, nodeData, triggerSpecs) {
    if ((elt instanceof HTMLAnchorElement && isLocalLink(elt) && (elt.target === '' || elt.target === '_self')) || (elt.tagName === 'FORM' && String(getRawAttribute(elt, 'method')).toLowerCase() !== 'dialog')) {
      ...
      if (path && path.split('/').reduce((_,b)=>b).indexOf('.')!=-1) {
        return
      }
